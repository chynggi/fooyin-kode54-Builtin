function(fooyin_print_summary)
    ...
    message(STATUS "  BUILD_SENSITIVE_TESTING : ${BUILD_SENSITIVE_TESTING}")
    message(STATUS "  BUILD_PLUGINS           : ${BUILD_PLUGINS}")
    message(STATUS "  PLUGIN_SELECTION        : ${PLUGIN_SELECTION}")
    message(STATUS "  BUILD_ALSA              : ${BUILD_ALSA}")
    message(STATUS "  FETCH_PROJECTM          : ${FETCH_PROJECTM}")
    message(STATUS "  FETCH_SPESSASYNTH       : ${FETCH_SPESSASYNTH}")
    message(STATUS "  FETCH_VGMSTREAM         : ${FETCH_VGMSTREAM}")
    message(STATUS "  FETCH_MGBA              : ${FETCH_MGBA}")
